...
/** A CpgGenerator generates Code Property Graphs from code. Each supported language implements a generator; astrail
  * ships with [[JavaSrcCpgGenerator]] for Java source and [[JavaCpgGenerator]] for JVM bytecode (JAR/WAR/EAR/CLASS).
  */
